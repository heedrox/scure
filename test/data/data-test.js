...
exports.data = {
  sentences: {
    ...
    'history-vanessa-1': 'historia1',
    'history-vanessa-2': 'historia2',
    'history-vanessa-3': 'historia2',
    'button-push': 'Tras pulsar el botón, veo cómo se vierten unas gotas del líquido de color {color} sobre un envase. ',
    'button-push-current-colors-plural': 'En el envase hay sustancias de colores {colors}.',
    'button-push-current-colors-singular': 'En el envase hay una sustancia de color {colors}.',
    'button-push-ok': 'Con los colores amarillo, azul y verde, una reacción química provoca que el aire tóxico de la sala desvanezca. El letrero con las letras TOXICO se apaga, y el cristal se abre. ¡Has abierto el acceso a la sala azul 1!',
    'button-push-ko': 'Los colores {colors} no reaccionan entre sí. El envase se vacía. No ha pasado nada.',
    'button-push-alreadyopen': 'La sala azul ya está abierta, no hace utilizar estos botones.',
  },
  init: {
    roomId: 'sala-mandos',
    welcome: [
  ...
  mapImage: {
    ...
    alt: 'Mapa con: sala cero, sala azul 1, sala azul 2, sala azul 3, sala rojo 1, sala rojo 2, sala rojo 3',
  },
  map: {
  ...
  usages: [
    ...
    anUsage(['comedor-gasotron', 'comedor-zanahoria'], [
      anUnlockingAction(pluginExtension(DummyExtension, 'Introduzco', DummyExtension), 'humanitysaved'),
    ], true),
